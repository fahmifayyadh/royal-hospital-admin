...
590
 var length = function (node) {
    ...
    var splitData = function (node, offset) {
      ...
      if (isTex
590
t(node)) { return node.splitText(offset); }
...
1640
  ...
  var settings = {
    ...
    options: {
      ...
      onImageUploadError: null, // imageUploadErrorHan
10b0
dler
      onToolbarClick: null,
...
G = 24;
    ...
    this.attach = function (oLayoutInfo, options) {
      ...
      this.bindKeyMap(oLayoutInfo, opt
1640
ions.keyMap[agent.bMac ? 'mac' : 'pc']);
...
turn '<div class="note-popover">' +
    ...
    var tplShortcutPara = function (lang) {
      var body = '<tr><td>⌘ + ⇧ + L</td><td>' + lang.paragraph.left + '</td></tr>' +
                 ...
                 '<tr><td>⌘ + ⇧ + NUM8</td><td>' + lang.lists.uno
590
rdered + '</td></tr>';
...
+
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      var isCon
160
tentEditable = !$holder.is(':disabled');
