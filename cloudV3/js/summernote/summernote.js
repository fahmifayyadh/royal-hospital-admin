...
(function (factory) {
  ...
  var list = (function () {
    ...
    /**
     * returns a copy of the collection with array typ
590
e.
...
ropzone'),
     ...
     * returns n
10b0
ew array of ancestor nodes (until predicate hit).
     *
     * @param {Element} node
...
turn offset;
     ...
     * @param {Element} pivot
b20
 - this will be boundaryPoint's node
  ...
  var settings = {
    ...
    options: {
      ...
      minHeight: null,              // set minimum heigh
590
t of editor
...
Range} textRange
    ...
    var textRange2bp = function (textRange, bStart) {
      ...
      if (nOffset !== 0 && dom.isText(aChild[nOffset - 1])) {
        ...
        /* jshint ignore:start */
        var sDummy = elCurText.nodeValue; //enforce IE to re-refer
10b0
ence elCurText, hack
        /* jshint ignore:end */
...
590
    ...
    this.insertTable = function ($editable, sDim) {
      ...
      range.cre
1640
ate().insertNode(table.createTable(aDim[0], aDim[1]));
    };
  ...
  var Button = function () {
    ...
    this.update = function ($container, oStyle) {
      ...
      btnState('button[data-event="justifyFull"]', fun
590
ction () {
  ...
  var Toolbar = function () {
    ...
    this.activate = function ($toolbar) {
      $toolbar.find('button')
2000
.not('button[data-event="codeview"]').removeClass('disabled');
    };
    ...
    this.showLinkDialog = function ($editable, $dialog, linkInfo) {
      return $.Deferred(function (deferred) {
        ...
        $linkDialog.one('shown.bs.modal', function () {
          ...
          }).val(linkInfo.url).trigger('focus').trigger
160
('select');
...
1bd0
    ...
    var hToolbarAndPopoverUpdate = function (event) {
      ...
      setTimeout(function () {
        ...
        var isAirMode = oLayoutInfo.editor().data(
10b0
'options').airMode;
        if (!isAirMode) {
    ...
    var hStatusbarMousedown = function (event) {
      ...
      var nEditableTop = $editable.offset().top - $document.scro
1640
llTop();
...
2000
    ...
    var tplButtonInfo = {
      ...
      paragraph: function (lang) {
        ...
        var rightButton = tplIconButton('fa fa-align-
6f0
