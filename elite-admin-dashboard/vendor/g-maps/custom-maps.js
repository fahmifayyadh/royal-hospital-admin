...
function map1() {
	...
	var mapOptions = {
		...
		center: new google.maps.LatLng(42.6500, -71.9400), // New York
	...
	var marker = new google.maps.Marker({
		position: new google.maps.LatLng(42.6500, -71.9400),
		map: map,
		title: 'Elite Admin!'
	});
}
...
function map9() {
  ...
  var mapOptions = {
    ...
    // The latitude and longitude to center the map (always required)
    center: new google.maps.LatLng(42.6500, -71.9200), // New York
