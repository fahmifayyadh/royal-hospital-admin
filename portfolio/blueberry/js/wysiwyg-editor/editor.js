	...
	var methods = {
		...
		init : function( options )
		{
			...
			var settings = $.extend({				
	       	...
	       	var containerDiv = $("<div/>",{ class : "Editor-container" });
			var $this = $(this).hide();	       	
		...
		createMenuItem: function(itemSettings, options, returnElement){
			...
			if(itemSettings["select"]){
				...
				menuWrapElement.append($('<a/>',{
										class:"btn btn-light-grey dropdown-toggle",
				...
				var menuWrapElement = $("<a/>",{href:'javascript:void(0)', class:'btn btn-light-grey'});
				var menuElement = $("<i/>");
				if(itemSettings["icon"])
					menuElement.addClass(itemSettings["icon"]);
				else
